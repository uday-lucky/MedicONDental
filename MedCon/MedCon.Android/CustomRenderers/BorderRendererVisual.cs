...
{
    public static void UpdateBackground(CustomControls.CustomView border, Android.Views.View view)
    {
    ...
    public static void SetClipPath(this CustomViewRenderer br, Canvas canvas)
    {
