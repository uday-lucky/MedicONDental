...
namespace MedCon.Cognito.Continuations
{
    public class AuthenticationDetails1
    {
         ...
         */
        public AuthenticationDetails1(String userId, String password,
         ...
         */
        public AuthenticationDetails1(String userId, Dictionary<String, String> authenticationParameters,
                Dictionary<String, String> validationData)
        {
            this.userId = userId;
