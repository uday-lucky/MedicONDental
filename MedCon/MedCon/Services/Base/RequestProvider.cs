...
namespace MedCon.Services.Base
{
    public class RequestProvider : IRequestProvider
    {
        ...
        private HttpClient CreateHttpClient()
        {
            ...
            if (!string.IsNullOrEmpty(MedCon.Helpers.Settings.Token))
            httpClient.DefaultRequestHeaders.Add("Authorization", MedCon.Helpers.Settings.Token);
        ...
        private async Task HandleResponse(HttpResponseMessage response)
        {
            if (!response.IsSuccessStatusCode)
            {
                ...
                {
                    throw new ServiceAuthenticationException("Unauthorized");
                }
