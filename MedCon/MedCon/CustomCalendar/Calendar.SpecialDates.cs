	...
	public partial class Calendar : ContentView
	{
		...
		protected void SetButtonSpecial(CalendarButton button, SpecialDate special)
		{
			Device.BeginInvokeOnMainThread(() =>
			{
				...
				if (special.BorderWidth.HasValue) button.CornerRadius = special.BorderWidth.Value;
				if (special.BorderColor.HasValue) button.OutlineColor = special.BorderColor.Value;
