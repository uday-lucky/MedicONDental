...
namespace MedCon.CustomCalendar
{
	public partial class Calendar : ContentView
	{
		...
		//							propertyChanged: (bindable, oldValue, newValue) => (bindable as Calendar).TitleLeftArrow.LabelText = (String)newValue);

		//public String TitleLeftArrowText
		//{
		//	get { return TitleLeftArrow.LabelText; }
		//	set { TitleLeftArrow.LabelText = value; }
		//}
		...
		//			propertyChanged: (bindable, oldValue, newValue) => (bindable as Calendar).TitleLeftArrow.CornerRadius = (float)newValue);

		//public float TitleLeftArrowBorderWidth
		//{
		...
		//			propertyChanged: (bindable, oldValue, newValue) => (bindable as Calendar).TitleLeftArrow.OutlineColor = (Color)newValue);

		//public Color TitleLeftArrowBorderColor
		//{
		//	get { return TitleLeftArrow.OutlineColor; }
		//	set { TitleLeftArrow.OutlineColor = value; }
		//}
		...
		//public float TitleLeftArrowBorderRadius
		//{
		//	get { return TitleLeftArrow.CornerRadius; }
		//	set { TitleLeftArrow.CornerRadius = value; }
		//}
		...
		/// </summary>
		public Image TitleLeftArrow { get; protected set; }
		...
		//							propertyChanged: (bindable, oldValue, newValue) => (bindable as Calendar).TitleRightArrow.LabelText = (String)newValue);

		//public String TitleRightArrowText
		//{
		//	get { return TitleRightArrow.LabelText; }
		//	set { TitleRightArrow.LabelText = value; }
		//}
		...
		//			propertyChanged: (bindable, oldValue, newValue) => (bindable as Calendar).TitleRightArrow.CornerRadius = (float)newValue);

		//public float TitleRightArrowBorderWidth
		//{
		...
		//			propertyChanged: (bindable, oldValue, newValue) => (bindable as Calendar).TitleRightArrow.OutlineColor = (Color)newValue);

		//public Color TitleRightArrowBorderColor
		//{
		//	get { return TitleRightArrow.OutlineColor; }
		//	set { TitleRightArrow.OutlineColor = value; }
		//}
		...
		//public float TitleRightArrowBorderRadius
		//{
		//	get { return TitleRightArrow.CornerRadius; }
		//	set { TitleRightArrow.CornerRadius = value; }
		//}
		...
		/// </summary>
		public Image TitleRightArrow { get; protected set; }
