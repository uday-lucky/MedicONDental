				...
				for (int r = 0; r < 4; r++)
				{
					for (int c = 0; c < 3; c++)
					{
						var b = new CalendarButton
						{
							...
							LabelText = DateTimeFormatInfo.CurrentInfo.MonthNames[(r * 3) + c],
                        ...
                        b.GestureRecognizers.Add(tapGesture1);
				...
				for (int r = 0; r < YearsRow; r++)
				{
					for (int c = 0; c < YearsColumn; c++)
					{
						...
						var b = new CalendarButton
						{
							HorizontalOptions = LayoutOptions.CenterAndExpand,
							VerticalOptions = LayoutOptions.CenterAndExpand,
							LabelText = string.Format("{0}", StartDate.Year + (t - (YearsColumn * YearsRow / 2))),
                        ...
                        b.GestureRecognizers.Add(tapGesture);
                        yearButtons.Add(b);
						details.Children.Add(b, c, r);
					}
				}
